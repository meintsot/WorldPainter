...
with open(path, 'rb') as f:
    ...
    for bi, fs in enumerate(indices):
        ...
        if 'Sections' not in cc: continue
        ...
        for si, sec in enumerate(cc['Sections']):
            ...
            print(f'Chunk ({local_x},{local_z}) Section {si} (Y {si*32}-{si*32+31}): palette={entries}')
            ...
            if has_levels:
                ...
                for i in range(32768):
                    ...
                    if (i & 1) == 0:
                        ...
                        lv = (ld[bi2] >> 4) & 0xF
                    if lv != 0 and len(levels_found) < 10:
                        x = i & 0x1F
                        z = (i >> 5) & 0x1F
                        y = (i >> 10) & 0x1F
...
print(f"\nTotal chunks with water found: {chunks_with_water}")
