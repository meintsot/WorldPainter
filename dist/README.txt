...
- The packaged HytaleAssets folder is intentionally trimmed to a small subset needed by WorldPainter, not the full game asset dump
- If Windows SmartScreen blocks the .bat file, click "More info" → "Run anyway"
- Uses a separate "WorldPainter [HYTALE]" config folder so it does not clash with regular WorldPainter
